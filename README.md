...
- Clerk와 Supabase 네이티브 통합 (2025년 권장 방식)
  ...
  - Clerk를 Supabase third-party auth provider로 설정
  - 자동 토큰 검증 및 RLS 정책 지원
...
**상세 가이드**: [Clerk + Supabase 통합 가이드](./docs/CLERK_SUPABASE_INTEGRATION.md)를 참고하세요.
...
**3-2. Supabase 대시보드에서 Clerk Provider 추가**

1. [Supabase Dashboard](https://supabase.com/dashboard)에 로그인
2. 프로젝트 선택 → **Authentication** → **Providers** → **Third-party Auth**
3. **Add provider** 클릭
4. **Clerk** 선택
5. 복사한 **Clerk domain**을 붙여넣기
6. **Save** 클릭

**3-3. 통합 확인**

통합이 완료되면 Clerk 세션 토큰이 Supabase 요청에 자동으로 포함되어 인증됩니다.

**참고 자료:**
- [상세 통합 가이드](./docs/CLERK_SUPABASE_INTEGRATION.md)
...
- [Clerk + Supabase 통합 가이드](./docs/CLERK_SUPABASE_INTEGRATION.md) - 상세 통합 설정 및 사용법
- [프로젝트 가이드](./AGENTS.md) - 개발 컨벤션 및 아키텍처
